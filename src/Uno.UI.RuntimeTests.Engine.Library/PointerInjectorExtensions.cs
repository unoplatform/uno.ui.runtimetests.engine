...
public static partial class TestPointersExtensions
{
	public static void Tap(this Pointers injector, UIElement elt)
		=> injector.TapCoordinates(GetAbsoluteCenter(elt));

	public static void TapCoordinates(this Pointers injector, Point point)
		=> injector.TapCoordinates(point.X, point.Y);

	public static void TapCoordinates(this Pointers injector, double x, double y)
	{
	...
	public static void Drag(this Pointers injector, UIElement elt, Point to)
		=> injector.DragCoordinates(GetAbsoluteCenter(elt), to);
	
	public static void Drag(this Pointers injector, UIElement elt, double toX, double toY)
		=> injector.DragCoordinates(GetAbsoluteCenter(elt), new Point(toX, toY));

	public static void DragCoordinates(this Pointers injector, Point from, Point to)
		=> injector.DragCoordinates(from.X, from.Y, to.X, to.Y);

	public static void DragCoordinates(this Pointers injector, double fromX, double fromY, double toX, double toY)
	{
		switch (injector.CurrentPointerType)
		{
			case PointerDeviceType.Touch:
	...
	private static NotSupportedException NotSupported([CallerMemberName] string operation = "")
		=> new($"'{operation}' with type '{Pointers.Instance.CurrentPointerType}' is not supported yet on this platform. Feel free to contribute!");
