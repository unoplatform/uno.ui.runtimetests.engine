...
[Instrumentation(Name = "uno.ui.runtimetests.engine.TestInstrumentation")]
public class TestInstrumentation : Instrumentation
{
    ...
    public override void OnStart()
    {
        ...
        var intent = new Intent(TargetContext!, typeof(MainActivity));
    ...
    sealed class ResultConsumer(Instrumentation instrumentation) : IDataConsumer
    {
